 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function La(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ma(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Oa(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ua(t))return"Blackberry";if(za(t))return"Webos";if(Da(t))return"Safari";if((t.includes("chrome/")||Ba(t))&&!t.includes("edge/"))return"Chrome";if(Pa(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Oa(e=bi()){return/firefox\//i.test(e)}function Da(e=bi()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ba(e=bi()){return/crios\//i.test(e)}function Ma(e=bi()){return/iemobile/i.test(e)}function Pa(e=bi()){return/android/i.test(e)}function Ua(e=bi()){return/blackberry/i.test(e)}function za(e=bi()){return/webos/i.test(e)}function Fa(e=bi()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function ja(){return vi()&&10===document.documentMode}function Wa(e=bi()){return Fa(e)||Pa(e)||za(e)||Ua(e)||/windows phone/i.test(e)||Ma(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
