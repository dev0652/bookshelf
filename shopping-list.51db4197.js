 ...
 * limitations under the License.
 */
var nu,ru=G("authIdTokenMaxAge")||300,au=null,iu=function(t){return n=e(i)(e(o).mark((function n(r){var a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=r,!e.t0){e.next=5;break}return e.next=4,r.getIdTokenResult();case 4:e.t0=e.sent;case 5:if(a=e.t0,!((i=a&&((new Date).getTime()-Date.parse(a.issuedAtTime))/1e3)&&i>ru)){e.next=9;break}return e.abrupt("return");case 9:if(s=null==a?void 0:a.token,au!==s){e.next=12;break}return e.abrupt("return");case 12:return au=s,e.next=15,fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:"Bearer ".concat(s)}:{}});case 15:case"end":return e.stop()}}),n)}))),function(e){return n.apply(this,arguments)};var n};nu="Browser",ot(new me("auth",(function(e,t){var n=t.options,r=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),i=r.options,o=i.apiKey,s=i.authDomain;return function(e,t){ta(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),ta(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});var r={apiKey:o,authDomain:s,clientPlatform:nu,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:fi(nu)},a=new di(e,t,r);return function(e,t){var n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(ia);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(a,n),a}(r,a)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((function(e,t,n){e.getProvider("auth-internal").initialize()}))),ot(new me("auth-internal",(function(e){var t=hi(e.getProvider("auth").getImmediate());return new tu(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),ht(Zs,eu,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(nu)),ht(Zs,eu,"esm2017");i=a("bpxeT"),o=a("2TvXO");var ou=a("dIxxU");ou.default.defaults.baseURL="https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app";var su,uu,cu,lu,fu=(su=e(i)(e(o).mark((function t(n){var r,a,i,s,u;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=localStorage.getItem("uid"),e.next=3,JSON.parse(r);case 3:return a=e.sent,i=localStorage.getItem("token"),e.next=7,JSON.parse(i);case 7:if(s=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.post("".concat(a,".json?auth=").concat(s),n);case 12:return u=e.sent,e.abrupt("return",u.data);case 14:case"end":return e.stop()}}),t)}))),function(e){return su.apply(this,arguments)}),pu=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.get("".concat(r,".json?auth=").concat(i));case 12:return s=e.sent,e.abrupt("return",s.data);case 14:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),du=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.delete("".concat(r,".json?auth=").concat(i));case 12:if(s=e.sent){e.next=15;break}return e.abrupt("return","<div>Loading...</div>");case 15:return e.abrupt("return",s.data);case 16:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),hu=(s=a("4Nugj"),u=a("lzhzI"),(0,s.default)()),vu=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:dt(),t=st(e=ve(e),qn);t.isInitialized()?t.getImmediate():Ur(e)}(pt({apiKey:"AIzaSyCq9mOndO3g-rUoq_LhFsLf4QY5_4L9fkc",authDomain:"books-314f3.firebaseapp.com",databaseURL:"https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app",projectId:"books-314f3",storageBucket:"books-314f3.appspot.com",messagingSenderId:"627795944798",appId:"1:627795944798:web:853f1b3c49bede1282dbcf",measurementId:"G-L8HC0K2SWK"})),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:dt(),t=st(e,"auth");if(t.isInitialized())return t.getImmediate();var n=oa(e,{popupRedirectResolver:Ks,persistence:[Ho,ko,wo]}),r=G("authTokenSyncURL");if(r){var a=iu(r);fo(n,a,(function(){return a(n.currentUser)})),lo(n,(function(e){return a(e)}))}var i=K("auth");return i&&mi(n,"http://".concat(i)),n}());function mu(e,t,n){so(vu,e,t,n).then((function(e){ku(e,n)})).catch((function(e){e.code,e.message}))}function gu(e,t){co(vu,e,t).then((function(e){var t=e.user.displayName;return ku(e,t),pu().then((function(e){if(null===e)return console.log("null"),void localStorage.setItem("list",null);var t=Object.keys(e),n=[],r=!0,a=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n.push(e[u])}}catch(e){a=!0,i=e}finally{try{r||null==s.return||s.return()}finally{if(a)throw i}}n.map((function(e){var t=JSON.stringify(e);localStorage.setItem("list",t)}))})),hu.userName.textContent=t})).catch((function(e){e.code,e.message}))}function yu(){po(vu).then((function(){return localStorage.setItem("uid",null),localStorage.setItem("token",null),localStorage.setItem("list",null),localStorage.setItem("userName",null),hu.userName.textContent=""})).catch((function(e){console.log(e.message)}))}function ku(e,t){var n=e.user.uid,r=e.user.accessToken;return localStorage.setItem("token",JSON.stringify(r)),localStorage.setItem("uid",JSON.stringify(n)),localStorage.setItem("userName",t),hu.userName.textContent=t}uu=function(e){if(e)return(0,u.userLogIn)(),hu.userName.textContent=e.displayName;console.log("User is signed out")},ve(vu).onAuthStateChanged(uu,cu,lu);var bu=(0,s.default)();function wu(){return(wu=e(i)(e(o).mark((function t(n){var r,a,i,s,c,l,f,p;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),r=n.currentTarget,a=r.elements,i=a.user_name,s=a.user_email,c=a.user_password,l=i.value,f=s.value,p=c.value,n.currentTarget.reset(),e.next=8,mu(f,p,l);case 8:(0,u.userLogIn)(),(0,u.handleClickOnSingUpCloseBtn)();case 10:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Iu(){return(Iu=e(i)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.preventDefault(),!(r=JSON.parse(localStorage.getItem("list")))){e.next=6;break}return e.next=5,du();case 5:fu(r);case 6:(0,u.userLogOut)(),yu();case 8:case"end":return e.stop()}}),t)})))).apply(this,arguments)}bu.formSingUp.addEventListener("submit",(function(e){return wu.apply(this,arguments)})),bu.formLogIn.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,n=t.user_email,r=t.user_password,a=n.value,i=r.value;e.currentTarget.reset(),(0,u.userLogIn)(),gu(a,i),(0,u.handleClickOnSingInCloseBtn)()})),bu.logOut.addEventListener("click",(function(e){return Iu.apply(this,arguments)}))}();
//# sourceMappingURL=shopping-list.51db4197.js.map
