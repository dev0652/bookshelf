 ...
 * limitations under the License.
 */
var Bs,Hs=D("authIdTokenMaxAge")||300,Ws=null,qs=function(t){return n=e(i)(e(o).mark((function n(r){var a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=r,!e.t0){e.next=5;break}return e.next=4,r.getIdTokenResult();case 4:e.t0=e.sent;case 5:if(a=e.t0,!((i=a&&((new Date).getTime()-Date.parse(a.issuedAtTime))/1e3)&&i>Hs)){e.next=9;break}return e.abrupt("return");case 9:if(s=null==a?void 0:a.token,Ws!==s){e.next=12;break}return e.abrupt("return");case 12:return Ws=s,e.next=15,fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:"Bearer ".concat(s)}:{}});case 15:case"end":return e.stop()}}),n)}))),function(e){return n.apply(this,arguments)};var n};Bs="Browser",Ke(new ne("auth",(function(e,t){var n=t.options,r=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),i=r.options,o=i.apiKey,s=i.authDomain;return function(e,t){zr(o&&!o.includes(":"),"invalid-api-key",{appName:e.name}),zr(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});var r={apiKey:o,authDomain:s,clientPlatform:Bs,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ya(Bs)},a=new Za(e,t,r);return function(e,t){var n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(qr);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(a,n),a}(r,a)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((function(e,t,n){e.getProvider("auth-internal").initialize()}))),Ke(new ne("auth-internal",(function(e){var t=ei(e.getProvider("auth").getImmediate());return new zs(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),et(Fs,Vs,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Bs)),et(Fs,Vs,"esm2017");i=a("bpxeT"),o=a("2TvXO");var Ks=a("dIxxU");Ks.default.defaults.baseURL="https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app";var Js,Gs,$s,Xs,Ys=(Js=e(i)(e(o).mark((function t(n){var r,a,i,s,u;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=localStorage.getItem("uid"),e.next=3,JSON.parse(r);case 3:return a=e.sent,i=localStorage.getItem("token"),e.next=7,JSON.parse(i);case 7:if(s=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,Ks.default.post("".concat(a,".json?auth=").concat(s),n);case 12:return u=e.sent,e.abrupt("return",u.data);case 14:case"end":return e.stop()}}),t)}))),function(e){return Js.apply(this,arguments)}),Qs=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,Ks.default.get("".concat(r,".json?auth=").concat(i));case 12:return s=e.sent,e.abrupt("return",s.data);case 14:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),Zs=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,Ks.default.delete("".concat(r,".json?auth=").concat(i));case 12:if(s=e.sent){e.next=15;break}return e.abrupt("return","<div>Loading...</div>");case 15:return e.abrupt("return",s.data);case 16:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),eu=(s=a("4Nugj"),u=a("lzhzI"),(0,s.default)()),tu=(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Ze(),t=Je(e=te(e),An);t.isInitialized()?t.getImmediate():xr(e)}(Qe({apiKey:"AIzaSyCq9mOndO3g-rUoq_LhFsLf4QY5_4L9fkc",authDomain:"books-314f3.firebaseapp.com",databaseURL:"https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app",projectId:"books-314f3",storageBucket:"books-314f3.appspot.com",messagingSenderId:"627795944798",appId:"1:627795944798:web:853f1b3c49bede1282dbcf",measurementId:"G-L8HC0K2SWK"})),function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Ze(),t=Je(e,"auth");if(t.isInitialized())return t.getImmediate();var n=Kr(e,{popupRedirectResolver:Ns,persistence:[Co,ao,oo]}),r=D("authTokenSyncURL");if(r){var a=qs(r);Yi(n,a,(function(){return a(n.currentUser)})),Xi(n,(function(e){return a(e)}))}var i=N("auth");return i&&ni(n,"http://".concat(i)),n}());function nu(e,t,n){Ji(tu,e,t,n).then((function(e){iu(e,n)})).catch((function(e){e.code,e.message}))}function ru(e,t){$i(tu,e,t).then((function(e){var t=e.user.displayName;return iu(e,t),Qs().then((function(e){if(null===e)return console.log("null"),void localStorage.setItem("list",null);var t=Object.keys(e),n=[],r=!0,a=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n.push(e[u])}}catch(e){a=!0,i=e}finally{try{r||null==s.return||s.return()}finally{if(a)throw i}}n.map((function(e){var t=JSON.stringify(e);localStorage.setItem("list",t)}))})),eu.userName.textContent=t})).catch((function(e){e.code,e.message}))}function au(){Qi(tu).then((function(){return localStorage.setItem("uid",null),localStorage.setItem("token",null),localStorage.setItem("list",null),localStorage.setItem("userName",null),eu.userName.textContent=""})).catch((function(e){console.log(e.message)}))}function iu(e,t){var n=e.user.uid,r=e.user.accessToken;return localStorage.setItem("token",JSON.stringify(r)),localStorage.setItem("uid",JSON.stringify(n)),localStorage.setItem("userName",t),eu.userName.textContent=t}Gs=function(e){if(e)return(0,u.userLogIn)(),eu.userName.textContent=e.displayName;console.log("User is signed out")},te(tu).onAuthStateChanged(Gs,$s,Xs);var ou=(0,s.default)();function su(){return(su=e(i)(e(o).mark((function t(n){var r,a,i,s,c,l,f,p;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n.preventDefault(),r=n.currentTarget,a=r.elements,i=a.user_name,s=a.user_email,c=a.user_password,l=i.value,f=s.value,p=c.value,n.currentTarget.reset(),e.next=8,nu(f,p,l);case 8:(0,u.userLogIn)(),(0,u.handleClickOnSingUpCloseBtn)();case 10:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function uu(){return(uu=e(i)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.preventDefault(),!(r=JSON.parse(localStorage.getItem("list")))){e.next=6;break}return e.next=5,Zs();case 5:Ys(r);case 6:(0,u.userLogOut)(),au();case 8:case"end":return e.stop()}}),t)})))).apply(this,arguments)}ou.formSingUp.addEventListener("submit",(function(e){return su.apply(this,arguments)})),ou.formLogIn.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,n=t.user_email,r=t.user_password,a=n.value,i=r.value;e.currentTarget.reset(),(0,u.userLogIn)(),ru(a,i),(0,u.handleClickOnSingInCloseBtn)()})),ou.logOut.addEventListener("click",(function(e){return uu.apply(this,arguments)}))}();
//# sourceMappingURL=index.8aae3723.js.map
