 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bi(e,t=1e3,n=2){const i=t*Math.pow(n,e),r=Math.round(.5*i*(Math.random()-.5)*2);return Math.min(144e5,i+r)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=[];var Wi,Hi;(Hi=Wi||(Wi={}))[Hi.DEBUG=0]="DEBUG",Hi[Hi.VERBOSE=1]="VERBOSE",Hi[Hi.INFO=2]="INFO",Hi[Hi.WARN=3]="WARN",Hi[Hi.ERROR=4]="ERROR",Hi[Hi.SILENT=5]="SILENT";const $i={debug:Wi.DEBUG,verbose:Wi.VERBOSE,info:Wi.INFO,warn:Wi.WARN,error:Wi.ERROR,silent:Wi.SILENT},qi=Wi.INFO,Vi={[Wi.DEBUG]:"log",[Wi.VERBOSE]:"log",[Wi.INFO]:"info",[Wi.WARN]:"warn",[Wi.ERROR]:"error"},Xi=(e,t,...n)=>{if(t<e.logLevel)return;const i=(new Date).toISOString(),r=Vi[t];if(!r)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[r](`[${i}]  ${e.name}:`,...n)};class Gi{constructor(e){this.name=e,this._logLevel=qi,this._logHandler=Xi,this._userLogHandler=null,ji.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Wi))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?$i[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Wi.DEBUG,...e),this._logHandler(this,Wi.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Wi.VERBOSE,...e),this._logHandler(this,Wi.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Wi.INFO,...e),this._logHandler(this,Wi.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Wi.WARN,...e),this._logHandler(this,Wi.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Wi.ERROR,...e),this._logHandler(this,Wi.ERROR,...e)}}let Ji,Ki;const Qi=new WeakMap,Yi=new WeakMap,Zi=new WeakMap,er=new WeakMap,tr=new WeakMap;let nr={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return Yi.get(e);if("objectStoreNames"===t)return e.objectStoreNames||Zi.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return or(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function ir(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(Ki||(Ki=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(...t){return e.apply(ar(this),t),or(Qi.get(this))}:function(...t){return or(e.apply(ar(this),t))}:function(t,...n){const i=e.call(ar(this),t,...n);return Zi.set(i,t.sort?t.sort():[t]),or(i)}}function rr(e){return"function"==typeof e?ir(e):(e instanceof IDBTransaction&&function(e){if(Yi.has(e))return;const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("complete",r),e.removeEventListener("error",o),e.removeEventListener("abort",o)},r=()=>{t(),i()},o=()=>{n(e.error||new DOMException("AbortError","AbortError")),i()};e.addEventListener("complete",r),e.addEventListener("error",o),e.addEventListener("abort",o)}));Yi.set(e,t)}(e),t=e,(Ji||(Ji=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])).some((e=>t instanceof e))?new Proxy(e,nr):e);var t}function or(e){if(e instanceof IDBRequest)return function(e){const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("success",r),e.removeEventListener("error",o)},r=()=>{t(or(e.result)),i()},o=()=>{n(e.error),i()};e.addEventListener("success",r),e.addEventListener("error",o)}));return t.then((t=>{t instanceof IDBCursor&&Qi.set(t,e)})).catch((()=>{})),tr.set(t,e),t}(e);if(er.has(e))return er.get(e);const t=rr(e);return t!==e&&(er.set(e,t),tr.set(t,e)),t}const ar=e=>tr.get(e);function sr(e,t,{blocked:n,upgrade:i,blocking:r,terminated:o}={}){const a=indexedDB.open(e,t),s=or(a);return i&&a.addEventListener("upgradeneeded",(e=>{i(or(a.result),e.oldVersion,e.newVersion,or(a.transaction))})),n&&a.addEventListener("blocked",(()=>n())),s.then((e=>{o&&e.addEventListener("close",(()=>o())),r&&e.addEventListener("versionchange",(()=>r()))})).catch((()=>{})),s}const lr=["get","getKey","getAll","getAllKeys","count"],cr=["put","add","delete","clear"],ur=new Map;function dr(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if(ur.get(t))return ur.get(t);const n=t.replace(/FromIndex$/,""),i=t!==n,r=cr.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!r&&!lr.includes(n))return;const o=async function(e,...t){const o=this.transaction(e,r?"readwrite":"readonly");let a=o.store;return i&&(a=a.index(t.shift())),(await Promise.all([a[n](...t),r&&o.done]))[0]};return ur.set(t,o),o}nr=(e=>({...e,get:(t,n,i)=>dr(t,n)||e.get(t,n,i),has:(t,n)=>!!dr(t,n)||e.has(t,n)}))(nr);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
Er("firebase","9.19.1","app");const Dr=new Si("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function Mr(e){return e instanceof Ei&&e.code.includes("request-failed")}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br({projectId:e}){return`https://firebaseinstallations.googleapis.com/v1/projects/${e}/installations`}function Pr(e){return{token:e.token,requestStatus:2,expiresIn:(t=e.expiresIn,Number(t.replace("s","000"))),creationTime:Date.now()};var t}async function Ur(e,t){const n=(await t.json()).error;return Dr.create("request-failed",{requestName:e,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function zr({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Fr(e,{refreshToken:t}){const n=zr(e);return n.append("Authorization",function(e){return`FIS_v2 ${e}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vr=new Map;function Xr(e,t){const n=qr(e);Gr(n,t),function(e,t){const n=Kr();n&&n.postMessage({key:e,fid:t});Qr()}(n,t)}function Gr(e,t){const n=Vr.get(e);if(n)for(const e of n)e(t)}let Jr=null;function Kr(){return!Jr&&"BroadcastChannel"in self&&(Jr=new BroadcastChannel("[Firebase] FID Change"),Jr.onmessage=e=>{Gr(e.data.key,e.data.fid)}),Jr}function Qr(){0===Vr.size&&Jr&&(Jr.close(),Jr=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function so({appConfig:e,heartbeatServiceProvider:t},n){const i=function(e,{fid:t}){return`${Br(e)}/${t}/authTokens:generate`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n);return(await lo(n,t)).token}function po(e){return Dr.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let No,_o;function To(e){_o=e}function Co(e){No=e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */)(o)||wo(o,u.measurementId),_o&&(r("consent","default",_o),To(void 0)),r("js",new Date);const f=null!==(s=null==a?void 0:a.config)&&void 0!==s?s:{};return f.origin="firebase",f.update=!0,null!=d&&(f.firebase_id=d),r("config",u.measurementId,f),No&&(r("set",No),Co(void 0)),u.measurementId}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(e,...t){throw Qo(e,...t)}function Jo(e,...t){return Qo(e,...t)}function Ko(e,t,n){const i=Object.assign(Object.assign({},$o()),{[t]:n});return new Si("auth","Firebase",i).create(t,{appName:e.name})}function Qo(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return qo.create(e,...t)}function Yo(e,t,...n){if(!e)throw Qo(t,...n)}function Zo(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Xo(t),new Error(t)}function ea(e,t){e||Zo(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function da(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function fa(e,t,n,i,r={}){return pa(e,r,(async()=>{let r={},o={};i&&("GET"===t?o=i:r={body:JSON.stringify(i)});const a=Ri(Object.assign({key:e.config.apiKey},o)).slice(1),s=await e._getAdditionalHeaders();return s["Content-Type"]="application/json",e.languageCode&&(s["X-Firebase-Locale"]=e.languageCode),la.fetch()(ma(e,e.config.apiHost,n,a),Object.assign({method:t,headers:s,referrerPolicy:"no-referrer"},r))}))}async function pa(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},ca),t);try{const t=new ga(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw ya(e,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const t=r.ok?o.errorMessage:o.error.message,[n,a]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw ya(e,"credential-already-in-use",o);if("EMAIL_EXISTS"===n)throw ya(e,"email-already-in-use",o);if("USER_DISABLED"===n)throw ya(e,"user-disabled",o);const s=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(a)throw Ko(e,s,a);Go(e,s)}}catch(t){if(t instanceof Ei)throw t;Go(e,"network-request-failed",{message:String(t)})}}async function ha(e,t,n,i,r={}){const o=await fa(e,t,n,i,r);return"mfaPendingCredential"in o&&Go(e,"multi-factor-auth-required",{_serverResponse:o}),o}function ma(e,t,n,i){const r=`${t}${n}?${i}`;return e.config.emulator?sa(e.config,r):`${e.config.apiScheme}://${r}`}class ga{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Jo(this.auth,"network-request-failed"))),ua.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function ya(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=Jo(e,t,i);return r.customData._tokenResponse=n,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sa{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Yo(e.idToken,"internal-error"),Yo(void 0!==e.idToken,"internal-error"),Yo(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=va(e);return Yo(t,"internal-error"),Yo(void 0!==t.exp,"internal-error"),Yo(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Yo(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function La(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ba(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Oa(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ua(t))return"Blackberry";if(za(t))return"Webos";if(Da(t))return"Safari";if((t.includes("chrome/")||Ma(t))&&!t.includes("edge/"))return"Chrome";if(Pa(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Oa(e=bi()){return/firefox\//i.test(e)}function Da(e=bi()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ma(e=bi()){return/crios\//i.test(e)}function Ba(e=bi()){return/iemobile/i.test(e)}function Pa(e=bi()){return/android/i.test(e)}function Ua(e=bi()){return/blackberry/i.test(e)}function za(e=bi()){return/webos/i.test(e)}function Fa(e=bi()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function ja(){return vi()&&10===document.documentMode}function Wa(e=bi()){return Fa(e)||Pa(e)||za(e)||Ua(e)||/windows phone/i.test(e)||Ba(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function Ja(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function Ka(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Qa{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Zo("not implemented")}_getIdTokenResponse(e){return Zo("not implemented")}_linkToIdToken(e,t){return Zo("not implemented")}_getReauthenticationResolver(e){return Zo("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ya(e,t){return fa(e,"POST","/v1/accounts:update",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class os{constructor(){this.providerId=os.PROVIDER_ID}static credential(e,t){return Za._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=rs.parseLink(t);return Yo(n,"argument-error"),Za._fromEmailAndCode(e,n.code,n.tenantId)}}os.PROVIDER_ID="password",os.EMAIL_PASSWORD_SIGN_IN_METHOD="password",os.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function bs(e,t,n=!1){const{auth:i}=e,r="reauthenticate";try{const o=await xa(e,gs(i,r,t,e),n);Yo(o.idToken,i,"internal-error");const a=va(o.idToken);Yo(a,i,"internal-error");const{sub:s}=a;return Yo(e.uid===s,i,"user-mismatch"),ps._forOperation(e,r,o)}catch(e){throw"auth/user-not-found"===(null==e?void 0:e.code)&&Go(i,"user-mismatch"),e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,o;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=Jo("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(o=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==o?o:document).appendChild(i)}))}function Hs(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Hs("rcb"),new aa(3e4,6e4);async function $s(e,t,n){var i;const r=await n.verify();try{let o;if(Yo("string"==typeof r,e,"argument-error"),Yo("recaptcha"===n.type,e,"argument-error"),o="string"==typeof t?{phoneNumber:t}:t,"session"in o){const t=o.session;if("phoneNumber"in o){Yo("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Vs(e,t){return t?na(t):(Yo(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qs.PROVIDER_ID="phone",qs.PHONE_SIGN_IN_METHOD="phone";class Xs extends Qa{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return es(e,this._buildIdpRequest())}_linkToIdToken(e,t){return es(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return es(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Gs(e){return ws(e.auth,new Xs(e),e.bypassAuthState)}function Js(e){const{auth:t,user:n}=e;return Yo(n,t,"internal-error"),bs(n,new Xs(e),e.bypassAuthState)}async function Ks(e){const{auth:t,user:n}=e;return Yo(n,t,"internal-error"),ys(n,new Xs(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qs{constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:o,type:a}=e;if(o)return void this.reject(o);const s={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(s))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Gs;case"linkViaPopup":case"linkViaRedirect":return Ks;case"reauthViaPopup":case"reauthViaRedirect":return Js;default:Go(this.auth,"internal-error")}}resolve(e){ea(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){ea(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pl=new aa(3e4,6e4);function hl(){const e=Os().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ml=null;function gl(e){return ml=ml||function(e){return new Promise(((t,n)=>{var i,r,o;function a(){hl(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{hl(),n(Jo(e,"network-request-failed"))},timeout:pl.get()})}if(null===(r=null===(i=Os().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Os().gapi)||void 0===o?void 0:o.load)){const t=Hs("iframefcb");return Os()[t]=()=>{gapi.load?a():n(Jo(e,"network-request-failed"))},Ws(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}a()}})).catch((e=>{throw ml=null,e}))}(e),ml}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yl=new aa(5e3,15e3),bl={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},wl=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function vl(e){const t=e.config;Yo(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?sa(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:"9.19.1"},r=wl.get(e.config.apiHost);r&&(i.eid=r);const o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),`${n}?${Ri(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",s),new kl(null);const d=window.open(t||"",s,u);Yo(d,e,"popup-blocked");try{d.focus()}catch(e){}return new kl(d)}function El(e,t,n,i,r,o){Yo(e.config.authDomain,e,"auth-domain-config-required"),Yo(e.config.apiKey,e,"invalid-api-key");const a={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"9.19.1",eventId:r};if(t instanceof as){t.setDefaultLanguage(e.languageCode),a.providerId=t.providerId||"",_i(t.getCustomParameters())||(a.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(o||{}))a[e]=t}if(t instanceof ss){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(a.scopes=e.join(","))}e.tenantId&&(a.tid=e.tenantId);const s=a;for(const e of Object.keys(s))void 0===s[e]&&delete s[e];return`${function({config:e}){return e.emulator?sa(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Ri(s).slice(1)}`}const Sl=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Cs,this._completeRedirectFn=ol,this._overrideRedirectResult=nl}async _openPopup(e,t,n,i){var r;ea(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return Il(e,El(e,t,n,ia(),i),As())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=El(e,t,n,ia(),i),Os().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(ea(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await gl(e),n=Os().gapi;return Yo(n,e,"internal-error"),t.open({where:document.body,url:vl(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:bl,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=Jo(e,"network-request-failed"),o=Os().setTimeout((()=>{i(r)}),yl.get());function a(){Os().clearTimeout(o),n(t)}t.ping(a).then(a,(()=>{i(r)}))}))))}(e),n=new al(e);return t.register("authEvent",(t=>{Yo(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),Go(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=dl(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Wa()||Da()||Fa()}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const _l=gi("authIdTokenMaxAge")||300;let Tl=null;var Cl;Cl="Browser",br(new Ui("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Yo(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Yo(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:Cl,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ha(Cl)},a=new qa(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(na);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(a,t),a})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),br(new Ui("auth-internal",(e=>{const t=Va(e.getProvider("auth").getImmediate());return new Nl(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Er("@firebase/auth","0.22.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Cl)),Er("@firebase/auth","0.22.0","esm2017"),Qt.defaults.baseURL="https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app";const Rl=async e=>{const t=localStorage.getItem("uid"),n=await JSON.parse(t),i=localStorage.getItem("token"),r=await JSON.parse(i);if(!r)return;return(await Qt.post(`${n}.json?auth=${r}`,e)).data},Al=async()=>{const e=localStorage.getItem("uid"),t=await JSON.parse(e),n=localStorage.getItem("token"),i=await JSON.parse(n);if(!i)return;return(await Qt.get(`${t}.json?auth=${i}`)).data},Ll=async()=>{const e=localStorage.getItem("uid"),t=await JSON.parse(e),n=localStorage.getItem("token"),i=await JSON.parse(n);if(!i)return;const r=await Qt.delete(`${t}.json?auth=${i}`);return r?r.data:"<div>Loading...</div>"};const Ol=(0,(wn=o("krGWQ")).default)(),Dl=(function(e=Ir()){const t=wr(e=Pi(e),"analytics");t.isInitialized()?t.getImmediate():function(e,t={}){const n=wr(e,"analytics");if(n.isInitialized()){const e=n.getImmediate();if(Ti(t,n.getOptions()))return e;throw go.create("already-initialized")}n.initialize({options:t})}(e)}(kr({apiKey:"AIzaSyCq9mOndO3g-rUoq_LhFsLf4QY5_4L9fkc",authDomain:"books-314f3.firebaseapp.com",databaseURL:"https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app",projectId:"books-314f3",storageBucket:"books-314f3.appspot.com",messagingSenderId:"627795944798",appId:"1:627795944798:web:853f1b3c49bede1282dbcf",measurementId:"G-L8HC0K2SWK"})),function(e=Ir()){const t=wr(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=wr(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ti(n.getOptions(),null!=t?t:{}))return e;Go(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Sl,persistence:[js,_s,Cs]}),i=gi("authTokenSyncURL");if(i){const e=(r=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>_l)return;const i=null==t?void 0:t.token;Tl!==i&&(Tl=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){Pi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){Pi(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var r;const o=mi("auth");return o&&Ga(n,`http://${o}`),n}());var Ml,Bl,Pl;function Ul(e,t,n){xs(Dl,e,t).then((e=>{Is(Dl.currentUser,{displayName:n}),jl(e,n)})).catch((e=>{e.code,e.message}))}function zl(e,t){ks(Dl,e,t).then((e=>{const t=e.user.displayName;return jl(e,t),Al().then((e=>{if(null===e)return console.log("null"),void localStorage.setItem("storage-of-books",null);const t=Object.keys(e),n=[];for(const i of t)n.push(e[i]);n.map((e=>{const t=JSON.stringify(e);localStorage.setItem("storage-of-books",t)}))})),Ol.userName.textContent=t})).catch((e=>{e.code,e.message}))}function Fl(){Es(Dl).then((()=>(localStorage.setItem("uid",null),localStorage.setItem("token",null),localStorage.setItem("storage-of-books",null),localStorage.setItem("userName",null),Ol.userName.textContent=""))).catch((e=>{console.log(e.message)}))}function jl(e,t){const n=e.user.uid,i=e.user.accessToken;return localStorage.setItem("token",JSON.stringify(i)),localStorage.setItem("uid",JSON.stringify(n)),localStorage.setItem("userName",t),Ol.userName.textContent=t}Ml=e=>{if(e)return Vn(),Ol.userName.textContent=e.displayName;console.log("User is signed out")},Pi(Dl).onAuthStateChanged(Ml,Bl,Pl);const Wl=(0,wn.default)();Wl.formSingUp.addEventListener("submit",(async function(e){e.preventDefault();const{elements:{user_name:t,user_email:n,user_password:i}}=e.currentTarget,r=t.value,o=n.value,a=i.value;e.currentTarget.reset(),await Ul(o,a,r),Vn(),$n()})),Wl.formLogIn.addEventListener("submit",(function(e){e.preventDefault();const{elements:{user_email:t,user_password:n}}=e.currentTarget,i=t.value,r=n.value;e.currentTarget.reset(),Vn(),zl(i,r),qn()})),Wl.logOut.addEventListener("click",(async function(e){e.preventDefault();const t=JSON.parse(localStorage.getItem("list"));t&&(await Ll(),Rl(t));Hn.userBarMenu.classList.add("user-out"),Hn.singUpBtn.classList.remove("user-in"),Fl()}));const Hl=(0,(wn=o("krGWQ")).default)();const $l=new class{#e="https://books-backend.p.goit.global/books";bookID=null;async fetchBookByID(){try{const e=await fetch(`${this.#e}/${this.bookID}`);return await e.json()}catch(e){console.log(e.message)}}},ql=document.querySelector(".modal-pop-up-btn"),Vl=JSON.parse(localStorage.getItem("storage-of-books"))||[];function Xl(e){var t;Vl.find((t=>t._id===e._id))?console.log("Ця книга вже у кошику"):(t=e,Vl.push(t),localStorage.setItem("storage-of-books",JSON.stringify(Vl)))}console.log(Vl),ql.addEventListener("click",(async function(e){try{const e=await $l.fetchBookByID();await Xl(e);if(Vl.find((t=>t._id===e._id)))return console.log("добавлено у кошик"),void(ql.textContent="STOP")}catch(e){console.log(e)}}));var Gl;Gl=new URL(o("kyEFX").resolve("3dsh1"),import.meta.url).toString();var Jl;Jl=new URL(o("kyEFX").resolve("1Fi3j"),import.meta.url).toString();var Kl;function Ql(){Hl.modalPopUp.classList.toggle("is-hidden")}Kl=new URL(o("kyEFX").resolve("6GerT"),import.meta.url).toString(),Hl.openModalPopUpBtn.addEventListener("click",(async function(e){$l.bookID="643282b1e85766588626a080";try{const e=await $l.fetchBookByID();Ql(),Hl.modalContentEl.innerHTML=function(e){const{_id:t,book_image:n,author:i,title:r,description:o,amazon_product_url:a,buy_links:[s,l,c,u,d,f]}=e,p=new URL(Gl).href,h=new URL(Jl).href,m=new URL(Kl).href;return`\n                        \n              <img class="modal-img" src="${n}"/>\n              <div class='modal-book-atributes'>\n              <p class="modal-book-title">${r}</p>\n              <p class="modal-book-author">${i}</p>\n              <p class="modal-book-desc">${o}</p>\n              <div class="modal-shops">\n              <a class="modal-shop-link" href="${a}" target="_blank">\n              <img class="modal-shop-img amazon" src="${m}" alt="Amazon link"/>\n              </a>\n              <a class="modal-shop-link" href="${l.url}" target="_blank">\n              <img class="modal-shop-img apple" src="${p}" alt="Apple Books link" />\n              </a>\n              <a class="modal-shop-link" href="${d.url}" target="_blank">\n              <img class="modal-shop-img" src="${h}" alt="Book Shop link"/>\n              </a>\n              </div>\n              </div>\n              \n          `}(e);if(Vl.find((t=>t._id===e._id)))return console.log("Ця книга вже у кошику"),void(ql.textContent="STOP")}catch(e){console.log(e)}})),Hl.closeModalPopUpBtn.addEventListener("click",(function(e){Ql(),Hl.modalContentEl.innerHTML=""})),window.addEventListener("keydown",(e=>{"Escape"===e.key&&Ql()})),Hl.modalPopUpBtn.addEventListener("click",(function(e){e.target.textContent="Remove from the shopping list",e.target.insertAdjacentHTML("afterend",'<p class="modal-message">Congratulations! You have added the book to the shopping list. To delete, press the button "Remove from the shopping list."</p>')}));const Yl={openMenuBtn:document.querySelector("[data-menu-open]"),closeMenuBtn:document.querySelector("[data-menu-close]"),menu:document.querySelector("[data-menu]")};function Zl(){Yl.menu.classList.toggle("is-open"),Yl.openMenuBtn.classList.toggle("is-hidden"),Yl.closeMenuBtn.classList.toggle("is-hidden"),Yl.openMenuBtn.classList.contains("is-hidden")&&(document.body.style.overflow="hidden"),Yl.closeMenuBtn.classList.contains("is-hidden")&&(document.body.style.overflow="")}Yl.openMenuBtn.addEventListener("click",Zl),Yl.closeMenuBtn.addEventListener("click",Zl);wn=o("krGWQ");const{categoryListEl:ec}=(0,wn.default)();!async function(){try{const e=await(async()=>{try{const{data:e}=await Qt.get("https://books-backend.p.goit.global/books/category-list");return e}catch(e){console.log(e)}})(),t=e.sort(((e,t)=>e.list_name.localeCompare(t.list_name)));for(const e of t){const t=document.createElement("li"),n=document.createElement("button");n.classList.add("category-btn"),n.textContent=`${e.list_name}`,ec.appendChild(t),t.appendChild(n)}}catch(e){console.log(e)}}();wn=o("krGWQ");const{categoryListEl:tc,allCategoriesBtn:nc}=(0,wn.default)();function ic(e){if(e.preventDefault(),"BUTTON"!==e.target.nodeName)return;const t=e.target,n=document.querySelector(".active-category");n&&n!==t&&n.classList.remove("active-category"),t.classList.add("active-category")}tc.addEventListener("click",ic),nc.addEventListener("click",ic);wn=o("krGWQ");const{allCategoriesBtn:rc,categoryContainerEl:oc,titleEl:ac}=(0,wn.default)();rc.addEventListener("click",(async function(e){e.preventDefault(),ac.innerHTML='Best Sellers <span class="home-bs__title-part">Books</span>',oc.innerHTML="",await xn()}));wn=o("krGWQ");const{header:sc,headerNavLinks:lc}=(0,wn.default)();lc.forEach((e=>{e.href===window.location.href||e.href===window.location.href+"index.html"?e.classList.add("current"):e.classList.remove("current")}));wn=o("krGWQ");const{scrollToTopButton:cc}=(0,wn.default)(),uc=new IntersectionObserver((function(e){e.forEach((e=>{e.isIntersecting?cc.classList.add("hidden"):cc.classList.remove("hidden")}))}));wn=o("krGWQ");const{colorSwitcher:dc}=(0,wn.default)();function fc(){const e=localStorage.getItem("dark-color-scheme");e&&(dc.checked="true"===e)}function pc(){dc.checked?document.body.classList.add("dark"):document.body.classList.remove("dark")}function hc(e){var t;pc(),t=e.currentTarget,localStorage.setItem("dark-color-scheme",t.checked)}wn=o("krGWQ"),wn=o("krGWQ");const{authForm:mc,nameField:gc,emailField:yc,passwordField:bc,authSubmitBtn:wc}=(0,wn.default)();function vc(e){e.preventDefault();const n=gc.value.trim(),i=yc.value.trim(),r=bc.value.trim();""!==n&&""!==i&&""!==r?/\S+@\S+\.\S+/.test(i)?r.length<5?t(gn).Notify.failure("Пароль має бути не менше 5 символів"):(t(gn).Notify.success("Форму успішно надіслано!"),mc.reset()):t(gn).Notify.failure("Будь ласка, введіть дійсну адресу електронної пошти"):t(gn).Notify.warning("Будь ласка заповніть усі поля")}mc.addEventListener("submit",vc);const{scrollToTopButton:xc,toTopTarget:kc,authForm:Ic}=(0,wn.default)();!function(){const{height:e}=sc.getBoundingClientRect();document.body.style.paddingTop=`${e}px`}(),fc(),pc(),dc.addEventListener("change",hc),uc.observe(kc),xc.addEventListener("click",(function(){window.scroll({top:0,behavior:"smooth"})})),Ic.addEventListener("submit",vc);
//# sourceMappingURL=index.87de2a4a.js.map
