 ...
 * limitations under the License.
 */
function Sr(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function kr(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function Or(){const e=Sr();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function Rr(){try{return"object"==typeof indexedDB}catch(e){return!1}}function Ar(){return new Promise(((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}}))}function Cr(){return!("undefined"==typeof navigator||!navigator.cookieEnabled)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dr(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}function Ur(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const i of n){if(!r.includes(i))return!1;const n=e[i],s=t[i];if(Br(n)&&Br(s)){if(!Ur(n,s))return!1}else if(n!==s)return!1}for(const e of r)if(!n.includes(e))return!1;return!0}function Br(e){return null!==e&&"object"==typeof e}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function Mr(e){const t=[];for(const[n,r]of Object.entries(e))Array.isArray(r)?r.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(r));return t.length?"&"+t.join("&"):""}function jr(e){const t={};return e.replace(/^\?/,"").split("&").forEach((e=>{if(e){const[n,r]=e.split("=");t[decodeURIComponent(n)]=decodeURIComponent(r)}})),t}function xr(e){const t=e.indexOf("?");if(!t)return"";const n=e.indexOf("#",t);return e.substring(t,n>0?n:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Jr(e){return e&&e._delegate?e._delegate:e}class Gr{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 ...
 * limitations under the License.
 */
class Si{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const ki="@firebase/app",Oi="0.9.8",Ri=new oi("@firebase/app"),Ai="[DEFAULT]",Ci={[ki]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Ni=new Map,Li=new Map;function Pi(e,t){try{e.container.addComponent(t)}catch(n){Ri.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Di(e){const t=e.name;if(Li.has(t))return Ri.debug(`There were multiple attempts to register component ${t}.`),!1;Li.set(t,e);for(const t of Ni.values())Pi(t,e);return!0}function Ui(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Bi=new Lr("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji="9.20.0";function xi(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:Ai,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw Bi.create("bad-app-name",{appName:String(i)});if(n||(n=Ir()),!n)throw Bi.create("no-options");const s=Ni.get(i);if(s){if(Ur(n,s.options)&&Ur(r,s.config))return s;throw Bi.create("duplicate-app",{appName:i})}const o=new Qr(i);for(const e of Li.values())o.addComponent(e);const a=new Mi(n,r,o);return Ni.set(i,a),a}function Fi(e=Ai){const t=Ni.get(e);if(!t&&e===Ai)return xi();if(!t)throw Bi.create("no-app",{appName:e});return t}function $i(e,t,n){var r;let i=null!==(r=Ci[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${i}" with version "${t}":`];return s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ri.warn(e.join(" "))}Di(new Gr(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const Hi="firebase-heartbeat-database",zi=1,Vi="firebase-heartbeat-store";let Wi=null;function qi(){return Wi||(Wi=bi(Hi,zi,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Vi)}}).catch((e=>{throw Bi.create("idb-open",{originalErrorMessage:e.message})}))),Wi}async function Ki(e,t){try{const n=(await qi()).transaction(Vi,"readwrite"),r=n.objectStore(Vi);return await r.put(t,Ji(e)),n.done}catch(e){if(e instanceof Nr)Ri.warn(e.message);else{const t=Bi.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Ri.warn(t.message)}}}function Ji(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gi{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Xi(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Yi();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Yi(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let r=e.slice();for(const i of e){const e=n.find((e=>e.agent===i.agent));if(e){if(e.dates.push(i.date),Qi(n)>t){e.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Qi(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}(this._heartbeatsCache.heartbeats),r=yr(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}}function Yi(){return(new Date).toISOString().substring(0,10)}class Xi{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!Rr()&&Ar().then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){try{return(await qi()).transaction(Vi).objectStore(Vi).get(Ji(e))}catch(e){if(e instanceof Nr)Ri.warn(e.message);else{const t=Bi.create("idb-get",{originalErrorMessage:null==e?void 0:e.message});Ri.warn(t.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Ki(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Ki(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}}function Qi(e){return yr(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Zi;Zi="",Di(new Gr("platform-logger",(e=>new Si(e)),"PRIVATE")),Di(new Gr("heartbeat",(e=>new Gi(e)),"PRIVATE")),$i(ki,Oi,Zi),$i(ki,Oi,"esm2017"),$i("fire-js","");
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ks="firebase-installations-database",Os=1,Rs="firebase-installations-store";let As=null;function Cs(){return As||(As=bi(ks,Os,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(Rs)}})),As}async function Ns(e,t){const n=ws(e),r=(await Cs()).transaction(Rs,"readwrite"),i=r.objectStore(Rs),s=await i.get(n);return await i.put(t,n),await r.done,s&&s.fid===t.fid||Es(e,t.fid),t}async function Ls(e){const t=ws(e),n=(await Cs()).transaction(Rs,"readwrite");await n.objectStore(Rs).delete(t),await n.done}async function Ps(e,t){const n=ws(e),r=(await Cs()).transaction(Rs,"readwrite"),i=r.objectStore(Rs),s=await i.get(n),o=t(s);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||s&&s.fid===o.fid||Es(e,o.fid),o}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function js({appConfig:e,heartbeatServiceProvider:t},n){const r=function(e,{fid:t}){return`${us(e)}/${t}/authTokens:generate`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n);return(await xs(n,t)).token}function zs(e){return as.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vs="installations",Ws=e=>{const t=Ui(e.getProvider("app").getImmediate(),Vs).getImmediate();return{getId:()=>async function(e){const t=e,{installationEntry:n,registrationPromise:r}=await Ds(t);return r?r.catch(console.error):xs(t).catch(console.error),n.fid}(t),getToken:e=>Hs(t,e)}};Di(new Gr(Vs,(e=>{const t=e.getProvider("app").getImmediate(),n=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(e,...t){throw jo(e,...t)}function Bo(e,...t){return jo(e,...t)}function Mo(e,t,n){const r=Object.assign(Object.assign({},No()),{[t]:n});return new Lr("auth","Firebase",r).create(t,{appName:e.name})}function jo(e,...t){if("string"!=typeof e){const n=t[0],r=[...t.slice(1)];return r[0]&&(r[0].appName=e.name),e._errorFactory.create(n,...r)}return Lo.create(e,...t)}function xo(e,t,...n){if(!e)throw jo(t,...n)}function Fo(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Do(t),new Error(t)}function $o(e,t){e||Fo(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yo(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function Xo(e,t,n,r,i={}){return Qo(e,i,(async()=>{let i={},s={};r&&("GET"===t?s=r:i={body:JSON.stringify(r)});const o=Mr(Object.assign({key:e.config.apiKey},s)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),Ko.fetch()(ea(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},i))}))}async function Qo(e,t,n){e._canInitEmulator=!1;const r=Object.assign(Object.assign({},Jo),t);try{const t=new ta(e),i=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const s=await i.json();if("needConfirmation"in s)throw na(e,"account-exists-with-different-credential",s);if(i.ok&&!("errorMessage"in s))return s;{const t=i.ok?s.errorMessage:s.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw na(e,"credential-already-in-use",s);if("EMAIL_EXISTS"===n)throw na(e,"email-already-in-use",s);if("USER_DISABLED"===n)throw na(e,"user-disabled",s);const a=r[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw Mo(e,a,o);Uo(e,a)}}catch(t){if(t instanceof Nr)throw t;Uo(e,"network-request-failed",{message:String(t)})}}async function Zo(e,t,n,r,i={}){const s=await Xo(e,t,n,r,i);return"mfaPendingCredential"in s&&Uo(e,"multi-factor-auth-required",{_serverResponse:s}),s}function ea(e,t,n,r){const i=`${t}${n}?${r}`;return e.config.emulator?qo(e.config,i):`${e.config.apiScheme}://${i}`}class ta{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Bo(this.auth,"network-request-failed"))),Go.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function na(e,t,n){const r={appName:e.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=Bo(e,t,r);return i.customData._tokenResponse=n,i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class la{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){xo(e.idToken,"internal-error"),xo(void 0!==e.idToken,"internal-error"),xo(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=sa(e);return xo(t,"internal-error"),xo(void 0!==t.exp,"internal-error"),xo(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return xo(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:r,expiresIn:i}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e,t){const n=await Qo(e,{},(async()=>{const n=Mr({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:r,apiKey:i}=e.config,s=ea(e,r,"/v1/token",`key=${i}`),o=await e._getAdditionalHeaders();return o["Content-Type"]="application/x-www-form-urlencoded",Ko.fetch()(s,{method:"POST",headers:o,body:n})}));return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}(e,t);this.updateTokensAndExpiration(n,r,Number(i))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(e,t){const{refreshToken:n,accessToken:r,expirationTime:i}=t,s=new la;return n&&(xo("string"==typeof n,"internal-error",{appName:e}),s.refreshToken=n),r&&(xo("string"==typeof r,"internal-error",{appName:e}),s.accessToken=r),i&&(xo("number"==typeof i,"internal-error",{appName:e}),s.expirationTime=i),s}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new la,this.toJSON())}_performRefresh(){return Fo("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wa(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(_a(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(ba(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Sa(t))return"Blackberry";if(ka(t))return"Webos";if(Ea(t))return"Safari";if((t.includes("chrome/")||Ia(t))&&!t.includes("edge/"))return"Chrome";if(Ta(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function ba(e=Sr()){return/firefox\//i.test(e)}function Ea(e=Sr()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ia(e=Sr()){return/crios\//i.test(e)}function _a(e=Sr()){return/iemobile/i.test(e)}function Ta(e=Sr()){return/android/i.test(e)}function Sa(e=Sr()){return/blackberry/i.test(e)}function ka(e=Sr()){return/webos/i.test(e)}function Oa(e=Sr()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ra(){return Or()&&10===document.documentMode}function Aa(e=Sr()){return Oa(e)||Ta(e)||ka(e)||Sa(e)||/windows phone/i.test(e)||_a(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ca(e,t=[]){let n;switch(e){case"Browser":n=wa(Sr());break;case"Worker":n=`${wa(Sr())}-${e}`;break;default:n=e}const r=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${ji}/${r}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ga(e,t){return Zo(e,"POST","/v1/accounts:signInWithIdp",Yo(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za{constructor(e){var t,n,r,i,s,o;const a=jr(xr(e)),c=null!==(t=a.apiKey)&&void 0!==t?t:null,u=null!==(n=a.oobCode)&&void 0!==n?n:null,l=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(r=a.mode)&&void 0!==r?r:null);xo(c&&u&&l,"argument-error"),this.apiKey=c,this.operation=l,this.code=u,this.continueUrl=null!==(i=a.continueUrl)&&void 0!==i?i:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}static parseLink(e){const t=function(e){const t=jr(xr(e)).link,n=t?jr(xr(t)).deep_link_id:null,r=jr(xr(e)).deep_link_id;return(r?jr(xr(r)).link:null)||r||n||t||e}(e);try{return new Za(t)}catch(e){return null}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ec{constructor(){this.providerId=ec.PROVIDER_ID}static credential(e,t){return Ja._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Za.parseLink(t);return xo(n,"argument-error"),Ja._fromEmailAndCode(e,n.code,n.tenantId)}}ec.PROVIDER_ID="password",ec.EMAIL_PASSWORD_SIGN_IN_METHOD="password",ec.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function vc(e,{displayName:t,photoURL:n}){if(void 0===t&&void 0===n)return;const r=Jr(e),i={idToken:await r.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},s=await oa(r,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tc extends Ec{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Tc.type="SESSION";const Sc=Tc;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class kc{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find((t=>t.isListeningto(e)));if(t)return t;const n=new kc(e);return this.receivers.push(n),n}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:n,eventType:r,data:i}=t.data,s=this.handlersMap[r];if(!(null==s?void 0:s.size))return;t.ports[0].postMessage({status:"ack",eventId:n,eventType:r});const o=Array.from(s).map((async e=>e(t.origin,i))),a=await function(e){return Promise.all(e.map((async e=>{try{return{fulfilled:!0,value:await e}}catch(e){return{fulfilled:!1,reason:e}}})))}(o);t.ports[0].postMessage({status:"done",eventId:n,eventType:r,response:a})}_subscribe(e,t){0===Object.keys(this.handlersMap).length&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),t&&0!==this.handlersMap[e].size||delete this.handlersMap[e],0===Object.keys(this.handlersMap).length&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */kc.receivers=[];class Rc{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const r="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!r)throw new Error("connection_unavailable");let i,s;return new Promise(((o,a)=>{const c=Oc("",20);r.port1.start();const u=setTimeout((()=>{a(new Error("unsupported_event"))}),n);s={messageChannel:r,onMessage(e){const t=e;if(t.data.eventId===c)switch(t.data.status){case"ack":clearTimeout(u),i=setTimeout((()=>{a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(i),o(t.data.response);break;default:clearTimeout(u),clearTimeout(i),a(new Error("invalid_response"))}}},this.handlers.add(s),r.port1.addEventListener("message",s.onMessage),this.target.postMessage({eventType:e,eventId:c,data:t},[r.port2])})).finally((()=>{s&&this.removeMessageHandler(s)}))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Cc(){return void 0!==Ac().WorkerGlobalScope&&"function"==typeof Ac().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const $c="recaptcha";async function Hc(e,t,n){var r;const i=await n.verify();try{let s;if(xo("string"==typeof i,e,"argument-error"),xo(n.type===$c,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){xo("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e,t){return Xo(e,"POST","/v2/accounts/mfaEnrollment:start",Yo(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:s.phoneNumber,recaptchaToken:i}});return n.phoneSessionInfo.sessionInfo}{xo("signin"===t.type,e,"internal-error");const n=(null===(r=s.multiFactorHint)||void 0===r?void 0:r.uid)||s.multiFactorUid;xo(n,e,"missing-multi-factor-info");const o=await function(e,t){return Xo(e,"POST","/v2/accounts/mfaSignIn:start",Yo(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:i}});return o.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return Xo(e,"POST","/v1/accounts:sendVerificationCode",Yo(e,t))}(e,{phoneNumber:s.phoneNumber,recaptchaToken:i});return t}}finally{n._reset()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Vc(e,t){return t?pa(t):(xo(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */zc.PROVIDER_ID="phone",zc.PHONE_SIGN_IN_METHOD="phone";class Wc extends Wa{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Ga(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Ga(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Ga(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function qc(e){return pc(e.auth,new Wc(e),e.bypassAuthState)}function Kc(e){const{auth:t,user:n}=e;return xo(n,t,"internal-error"),fc(n,new Wc(e),e.bypassAuthState)}async function Jc(e){const{auth:t,user:n}=e;return xo(n,t,"internal-error"),dc(n,new Wc(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gc{constructor(e,t,n,r,i=!1){this.auth=e,this.resolver=n,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:r,tenantId:i,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return qc;case"linkViaPopup":case"linkViaRedirect":return Jc;case"reauthViaPopup":case"reauthViaRedirect":return Kc;default:Uo(this.auth,"internal-error")}}resolve(e){$o(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){$o(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const du=new Wo(3e4,6e4);function fu(){const e=Ac().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let pu=null;function gu(e){return pu=pu||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){fu(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{fu(),n(Bo(e,"network-request-failed"))},timeout:du.get()})}if(null===(i=null===(r=Ac().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ac().gapi)||void 0===s?void 0:s.load)){const t=Ua("iframefcb");return Ac()[t]=()=>{gapi.load?o():n(Bo(e,"network-request-failed"))},Da(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw pu=null,e}))}(e),pu}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mu=new Wo(5e3,15e3),yu="__/auth/iframe",vu="emulator/auth/iframe",wu={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},bu=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Eu(e){const t=e.config;xo(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?qo(t,vu):`https://${e.config.authDomain}/${yu}`,r={apiKey:t.apiKey,appName:e.name,v:ji},i=bu.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Mr(r).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new _u(null);const h=window.open(t||"",a,l);xo(h,e,"popup-blocked");try{h.focus()}catch(e){}return new _u(h)}const Su="__/auth/handler",ku="emulator/auth/handler",Ou=encodeURIComponent("fac");async function Ru(e,t,n,r,i,s){xo(e.config.authDomain,e,"auth-domain-config-required"),xo(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:r,v:ji,eventId:i};if(t instanceof tc){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",Dr(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof nc){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];const c=await e._getAppCheckToken(),u=c?`#${Ou}=${encodeURIComponent(c)}`:"";return`${function({config:e}){return e.emulator?qo(e,ku):`https://${e.authDomain}/${Su}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Mr(a).slice(1)}${u}`}const Au="webStorageSupport";const Cu=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Sc,this._completeRedirectFn=iu,this._overrideRedirectResult=tu}async _openPopup(e,t,n,r){var i;$o(null===(i=this.eventManagers[e._key()])||void 0===i?void 0:i.manager,"_initialize() not called before _openPopup()");return Tu(e,await Ru(e,t,n,Ho(),r),Oc())}async _openRedirect(e,t,n,r){await this._originValidation(e);return function(e){Ac().location.href=e}(await Ru(e,t,n,Ho(),r)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):($o(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await gu(e),n=Ac().gapi;return xo(n,e,"internal-error"),t.open({where:document.body,url:Eu(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:wu,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=Bo(e,"network-request-failed"),s=Ac().setTimeout((()=>{r(i)}),mu.get());function o(){Ac().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{r(i)}))}))))}(e),n=new su(e);return t.register("authEvent",(t=>{xo(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Au,{type:Au},(n=>{var r;const i=null===(r=null==n?void 0:n[0])||void 0===r?void 0:r[Au];void 0!==i&&t(!!i),Uo(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=lu(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Aa()||Ea()||Oa()}};var Nu="@firebase/auth",Lu="0.23.0";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Du=_r("authIdTokenMaxAge")||300;let Uu=null;var Bu;Bu="Browser",Di(new Gr("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:s,authDomain:o}=n.options;xo(s&&!s.includes(":"),"invalid-api-key",{appName:n.name}),xo(!(null==o?void 0:o.includes(":")),"argument-error",{appName:n.name});const a={apiKey:s,authDomain:o,clientPlatform:Bu,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ca(Bu)},c=new xa(n,r,i,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(pa);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(c,t),c}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Di(new Gr("auth-internal",(e=>(e=>new Pu(e))(Fa(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),$i(Nu,Lu,function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Bu)),$i(Nu,Lu,"esm2017"),rn.defaults.baseURL="https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app";const Mu=async e=>{const t=localStorage.getItem("uid"),n=await JSON.parse(t),r=localStorage.getItem("token"),i=await JSON.parse(r);if(!i)return;return(await rn.post(`${n}.json?auth=${i}`,e)).data},ju=async()=>{const e=localStorage.getItem("uid"),t=await JSON.parse(e),n=localStorage.getItem("token"),r=await JSON.parse(n);if(!r)return;return(await rn.get(`${t}.json?auth=${r}`)).data},xu=async()=>{const e=localStorage.getItem("uid"),t=await JSON.parse(e),n=localStorage.getItem("token"),r=await JSON.parse(n);if(!r)return;const i=await rn.delete(`${t}.json?auth=${r}`);return i?i.data:"<div>Loading...</div>"};s=i("4Nugj"),Sn=i("6JpON");const Fu=(0,s.default)(),$u=(function(e=Fi()){const t=Ui(e=Jr(e),qs);t.isInitialized()?t.getImmediate():function(e,t={}){const n=Ui(e,qs);if(n.isInitialized()){const e=n.getImmediate();if(Ur(t,n.getOptions()))return e;throw Zs.create("already-initialized")}const r=n.initialize({options:t})}(e)}(xi({apiKey:"AIzaSyCq9mOndO3g-rUoq_LhFsLf4QY5_4L9fkc",authDomain:"books-314f3.firebaseapp.com",databaseURL:"https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app",projectId:"books-314f3",storageBucket:"books-314f3.appspot.com",messagingSenderId:"627795944798",appId:"1:627795944798:web:853f1b3c49bede1282dbcf",measurementId:"G-L8HC0K2SWK"})),function(e=Fi()){const t=Ui(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Ui(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Ur(n.getOptions(),null!=t?t:{}))return e;Uo(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Cu,persistence:[Fc,_c,Sc]}),r=_r("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Du)return;const r=null==t?void 0:t.token;Uu!==r&&(Uu=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Jr(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Jr(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=Er("auth");return s&&Ha(n,`http://${s}`),n}());var Hu,zu,Vu;function Wu(e,t,n){mc($u,e,t).then((e=>{vc($u.currentUser,{displayName:n}),Ju(e,n)})).catch((e=>{e.code,e.message}))}function qu(e,t){yc($u,e,t).then((e=>{const t=e.user.displayName;return Ju(e,t),ju().then((e=>{if(null===e)return;const t=Object.keys(e),n=[];for(const r of t)n.push(e[r]);n.map((e=>{const t=[...e],n=JSON.parse(localStorage.getItem("storage-of-books"));if(null!==n){const r=[];for(e of n){const n=e._id;console.log(n);t.every((e=>e._id!==n))&&r.push(e);const i=[...t,...r];localStorage.setItem("storage-of-books",JSON.stringify(i))}return}const r=JSON.stringify(t);localStorage.setItem("storage-of-books",r)}))})),Fu.userName.textContent=t})).catch((e=>{Sn.Notify.failure("This user do not registered");e.code,e.message}))}function Ku(){wc($u).then((()=>(localStorage.setItem("uid",null),localStorage.setItem("token",null),localStorage.setItem("storage-of-books",null),localStorage.setItem("userName",null),Fu.userName.textContent=""))).catch((e=>{console.log(e.message)}))}function Ju(e,t){const n=e.user.uid,r=e.user.accessToken;return localStorage.setItem("token",JSON.stringify(r)),localStorage.setItem("uid",JSON.stringify(n)),localStorage.setItem("userName",t),Fu.userName.textContent=t}Hu=e=>{if(e)return Qn(),Fu.userName.textContent=e.displayName;console.log("User is signed out")},Jr($u).onAuthStateChanged(Hu,zu,Vu);const Gu=(0,s.default)();Gu.formSingUp.addEventListener("submit",(async function(e){e.preventDefault();const{elements:{user_name:t,user_email:n,user_password:r}}=e.currentTarget,i=t.value,s=n.value,o=r.value;e.currentTarget.reset(),await Wu(s,o,i),Qn(),Yn()})),Gu.formLogIn.addEventListener("submit",(function(e){e.preventDefault();const{elements:{user_email:t,user_password:n}}=e.currentTarget,r=t.value,i=n.value;e.currentTarget.reset(),qu(r,i),Xn();JSON.parse(localStorage.getItem("token"))&&Qn()})),Gu.logOut.addEventListener("click",(async function(e){e.preventDefault();const t=JSON.parse(localStorage.getItem("storage-of-books"));t&&(await xu(),Mu(t));Gn.userBarMenu.classList.add("user-out"),Gn.singUpBtn.classList.remove("user-in"),Ku()}));var Yu=i("hEzkB");i("bX5OU"),i("9v99b");var Xu=i("bX5OU");s=i("4Nugj");const{titleEl:Qu,categoryContainerEl:Zu,selectedBooksListEl:el}=(0,s.default)();Zu.addEventListener("click",(async function(e){if(e.target.classList.contains("see-more-btn")){const t=e.target.attributes.id.value,n=t.split(" ");lastWord=n[n.length-1];const r=t.split(" ").slice(0,-1).join(" ");Qu.textContent=r,Qu.innerHTML+=` <span class="home-bs__title-part">${lastWord}</span>`;const i=await Pn(t),s=document.querySelectorAll(".category-btn"),o=document.querySelector(".active-category");for(const e of s)e.textContent===t&&e.classList.add("active-category");o.classList.remove("active-category"),el.insertAdjacentHTML("beforeend",Un(i)),(0,Xu.scrollToTop)()}}));(0,s.default)().authForm.addEventListener("submit",Yu.validateOnSubmit)}();
//# sourceMappingURL=index.06c72e89.js.map
