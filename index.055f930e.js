 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(tu)),ht(Qs,Zs,"esm2017");i=a("bpxeT"),o=a("2TvXO");var ou=a("dIxxU");ou.default.defaults.baseURL="https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app";var su,uu=(su=e(i)(e(o).mark((function t(n){var r,a,i,s,u;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=localStorage.getItem("uid"),e.next=3,JSON.parse(r);case 3:return a=e.sent,i=localStorage.getItem("token"),e.next=7,JSON.parse(i);case 7:if(s=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.post("".concat(a,".json?auth=").concat(s),n);case 12:return u=e.sent,e.abrupt("return",u.data);case 14:case"end":return e.stop()}}),t)}))),function(e){return su.apply(this,arguments)}),cu=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.get("".concat(r,".json?auth=").concat(i));case 12:return s=e.sent,e.abrupt("return",s.data);case 14:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),lu=function(){var t=e(i)(e(o).mark((function t(){var n,r,a,i,s;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=localStorage.getItem("uid"),e.next=3,JSON.parse(n);case 3:return r=e.sent,a=localStorage.getItem("token"),e.next=7,JSON.parse(a);case 7:if(i=e.sent){e.next=10;break}return e.abrupt("return");case 10:return e.next=12,ou.default.delete("".concat(r,".json?auth=").concat(i));case 12:if(s=e.sent){e.next=15;break}return e.abrupt("return","<div>Loading...</div>");case 15:return e.abrupt("return",s.data);case 16:case"end":return e.stop()}}),t)})));return function(){return t.apply(this,arguments)}}(),fu=(0,(s=a("4Nugj")).default)();!function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:dt(),t=st(e=ve(e),qn);t.isInitialized()?t.getImmediate():Ur(e)}(pt({apiKey:"AIzaSyCq9mOndO3g-rUoq_LhFsLf4QY5_4L9fkc",authDomain:"books-314f3.firebaseapp.com",databaseURL:"https://books-314f3-default-rtdb.europe-west1.firebasedatabase.app",projectId:"books-314f3",storageBucket:"books-314f3.appspot.com",messagingSenderId:"627795944798",appId:"1:627795944798:web:853f1b3c49bede1282dbcf",measurementId:"G-L8HC0K2SWK"}));function pu(e,t,n){so(iu(),e,t,n).then((function(e){var t=e.user.uid,r=e.user.accessToken,a=JSON.stringify(r),i=JSON.stringify(t);return localStorage.setItem("token",a),localStorage.setItem("uid",i),fu.userName.textContent=n})).catch((function(e){e.code,e.message}))}function du(e,t){co(iu(),e,t).then((function(e){var t=e.user.uid,n=e.user.accessToken;localStorage.setItem("token",JSON.stringify(n)),localStorage.setItem("uid",JSON.stringify(t));var r=e.user.displayName;return cu().then((function(e){if(console.log(e),null===e)return console.log("null"),void localStorage.setItem("list",null);var t=Object.keys(e),n=[],r=!0,a=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;n.push(e[u])}}catch(e){a=!0,i=e}finally{try{r||null==s.return||s.return()}finally{if(a)throw i}}n.map((function(e){var t=JSON.stringify(e);localStorage.setItem("list",t)}))})),fu.userName.textContent=r})).catch((function(e){e.code,e.message}))}function hu(){po(iu()).then((function(){return localStorage.setItem("uid",null),localStorage.setItem("token",null),localStorage.setItem("list",null),fu.userName.textContent=""})).catch((function(e){console.log(e.message)}))}var vu=(0,s.default)();function mu(){return(mu=e(i)(e(o).mark((function t(n){var r;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(n.preventDefault(),!(r=JSON.parse(localStorage.getItem("list")))){e.next=7;break}return e.next=5,lu();case 5:console.log(r),uu(r);case 7:hu();case 8:case"end":return e.stop()}}),t)})))).apply(this,arguments)}console.log(vu.logOut),vu.formSingUp.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,n=t.signup_user_name,r=t.user_email,a=t.user_password,i=n.value,o=r.value,s=a.value;e.currentTarget.reset(),pu(o,s,i),(0,u.handleClickOnSingUpCloseBtn)()})),vu.formLogIn.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,n=t.user_email,r=t.user_password,a=n.value,i=r.value;e.currentTarget.reset(),du(a,i),(0,u.handleClickOnSingInCloseBtn)()})),vu.logOut.addEventListener("click",(function(e){return mu.apply(this,arguments)}))}();
//# sourceMappingURL=index.055f930e.js.map
